...
class _ProfileSelectionPageState extends State<ProfileSelectionPage> {
  // List of available profiles and loading flag.
  ...
  Future<void> _loadProfiles() async {
    // Load all saved profiles then refresh state.
  ...
  Future<void> _selectProfile(UserProfile profile) async {
    // Set the chosen profile as active and open the main page.
  ...
  Future<void> _deleteProfile(UserProfile profile) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          ...
          'All associated weight data will be removed.',
        ),
        actions: [
          TextButton(
    ...
    if (confirm == true) {
      // Delete the selected profile and reload list.
  ...
  Future<void> _editProfile(UserProfile profile) async {
    // Open edit page, then reload list when returning.
  ...
  Future<void> _addProfile() async {
    // Open profile creation page, then reload list.
    await Navigator.push(
      context,
      ...
      body: _loading
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                // Card summarizing a profile with actions (select/edit/delete).
                return Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${profile.weight.toStringAsFixed(1)} kg — Goal: ${profile.goalWeight.toStringAsFixed(1)} kg',
